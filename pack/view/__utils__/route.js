...
const ROUTE_INFO_MAP = {
  ...
  [ROUTE_MAP.TEST_AUTH]: { title: 'Auth', iconName: 'extension', onClick: () => (window.location.href = ROUTE_MAP.TEST_AUTH) },
  [ROUTE_MAP.TEST_WEBSOCKET]: { title: 'WebSocket', iconName: 'extension', onClick: () => (window.location.href = ROUTE_MAP.TEST_WEBSOCKET) },
